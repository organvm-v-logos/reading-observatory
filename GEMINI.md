...
**Org:** `organvm-v-logos` | **Repo:** `reading-observatory`

### Edges
- **Produces** → `ORGAN-V`: curated-reading-lists
- **Produces** → `ORGAN-V`: relevant-articles
- **Consumes** ← `{'organ': 'EXTERNAL', 'repo': 'various'}`: external-rss-feeds

### Siblings in Public Process
`public-process`, `.github`, `analytics-engine`, `editorial-standards`, `essay-pipeline`
...
Run: `organvm ecosystem show reading-observatory` | `organvm ecosystem validate --organ V`
